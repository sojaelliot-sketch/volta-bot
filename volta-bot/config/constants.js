...
module.exports = {
  ...
  BADGES: {
    ...
    win_streak_20:   { emoji: '🌋', label: '20-Win Streak',        desc: 'Won 20 matches in a row.' },
    ...
    goal_frenzy:     { emoji: '🎯', label: 'Goal Frenzy',          desc: 'Scored 500 career goals.' },
    champion:        { emoji: '🏆', label: 'Champion',             desc: 'Won a tournament.' },
    dynasty:         { emoji: '🏅', label: 'Dynasty',              desc: 'Won 5 tournaments.' },
    high_roller:     { emoji: '💎', label: 'High Roller',          desc: 'Held 10,000+ Metaworks at once.' },
    millionaire:     { emoji: '💰', label: 'Millionaire',          desc: 'Held 100,000+ Metaworks at once.' },
    market_mogul:    { emoji: '📈', label: 'Market Mogul',         desc: 'Made 50 market sales.' },
    scout_master:    { emoji: '🔍', label: 'Scout Master',         desc: 'Scouted 20 academy prospects.' },
    unbeatable:      { emoji: '🛡️', label: 'Unbeatable',           desc: 'Went 30 matches without a loss.' },
    hat_trick_hero:  { emoji: '🎯', label: 'Hat Trick Hero',       desc: 'Scored a hat trick in a match.' },
    veteran:         { emoji: '🎖️', label: 'Veteran',              desc: 'Played 200 matches.' },
    social_butterfly:{ emoji: '🦋', label: 'Social Butterfly',     desc: 'Sent 50 chat messages.' },
    generous:        { emoji: '🫶', label: 'Generous',             desc: 'Tipped 10,000+ Metaworks total.' },
    early_bird:      { emoji: '🐦', label: 'Early Bird',           desc: 'Logged in within 1 hour of server start.' },
    dark_mode:       { emoji: '🌙', label: 'Dark Mode Fan',        desc: 'Toggled dark mode on.' },
  },
